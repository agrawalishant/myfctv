        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card pb-3">
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center pb-3">
                        ...
                        @if ($seriesModule['edit_access'] == 1 || $seriesModule['full_access'] == 1)
                            <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas"
                                data-bs-target="#season-offcanvas" aria-controls="season-offcanvas"><i
                                    class="fa-solid fa-plus me-2"></i>Create Series</button>
                        @endif
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($series as $item)
                                        <tr>
                                            ...
                                            <td style="text-transform: capitalize">{{ $item['content_type'] }}</td>
                                            <td style="text-transform: capitalize">{{ $item['genre'] }}</td>
                                            <td>
                                                <div class="d-flex align-items-center list-user-action">
                                                    @if ($seriesModule['edit_access'] == 1 || $seriesModule['full_access'] == 1)
                                                        <a class="btn btn-sm btn-icon btn-warning  rounded"
                                                            title="Manage Series"
                                                            href="{{ url('dashboard/series/edit/' . $item['id']) }}">
                                                            <i class="fa-solid fa-pen"></i>
                                                        </a>
                                                    @endif
                                                    @if ($seriesModule['full_access'] == 1)
                                                        <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2 series-delete-btn"
                                                            role="button" data-toggle="tooltip" data-placement="top"
                                                            title="Delete Series" data-original-title="Delete"
            ...
            <div class="offcanvas offcanvas-end offcanvas-width-80" tabindex="-1" id="season-offcanvas"
                ...
                <div class="offcanvas-header">
                    <h5 id="offcanvasRightLabel1">Add New Series</h5>
                    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                        aria-label="Close"></button>
                </div>
                <div class="offcanvas-body">
                    <div class="error-text text-center text-danger mb-4" id="series_error"></div>
                    <form id="series_form" method="POST" action="{{ url('dashboard/series/upload') }}"
                        ...
                        <div class="section-form">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group px-5 ">
                                            <label class="form-label flex-grow-1" for="Series Name">
                                                <strong>Series Name</strong> <span class="text-danger">*</span>:
                                            </label>
                                            <input id="Series Name" name="title" type="text" name="title"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group px-5">
                                                    <label class="form-label"
                                                        for="rating"><strong>Rating</strong>:</label>
                                ...
                                <div class="row mt-5">
                                    <div class="col-lg-4">
                                        <div class="form-group px-5 ">
                                            <label class="form-label flex-grow-1" for="Content Type">
                                                <strong>Content Type</strong> :
                                            </label>

                                            <select id="movie-access" name="content_type" type="select"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group px-5">
                                            <label class="form-label flex-grow-1"
                                                for="genres"><strong>Genre:</strong></label>
                                            <select id="genres" name="category_id" type="select"
                                                class="form-control select2-basic-multiple"
                                                placeholder="select movie access">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group px-5 ">
                                            <label class="form-label flex-grow-1" for="Short Description">
                                                <strong>Short Description</strong> <span class="text-danger">*</span>:
                                            </label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group px-5 ">
                                            <label class="form-label flex-grow-1" for="Long Description">
                                                <strong>Long Description</strong> <span class="text-danger">*</span>:
                                            </label>

                                            <!-- textarea input -->
                                            <textarea id="Long Description" name="long_description" class="form-control" placeholder="Long Description"></textarea>
                ...
                <div class="offcanvas-footer border-top">
                    <div class="d-grid d-flex gap-3 p-3">
                        <button id="series_submit" type="submit" class="btn btn-primary d-block">
