                        ...
                        <div class="sign-user_card">
                            <div class="sign-in-page-data">
                                <div class="sign-in-from w-100 m-auto">
                                    <h3 class="mb-3 text-center" style="color: #fff">Reset Password</h3>
                                    <p class="text-body">Enter your email address and we'll send you an email with
                                        instructions to reset your password.</p>
                                    <form id="forgot-password-form" action="{{url('password-link')}}" method="post" class="mt-4">@csrf
                                        <div class="mb-3">
                                            <input placeholder="Enter email" name="email" type="email" class="mb-0 form-control">
                                            <span id="email_error" class="text-danger error-text email_error"></span>
                                        </div>
                                        <div class="sign-info" style="text-align: center !important">
                                            <button type="submit" id="email_submit" class="btn btn-btn btn-primary">Send me reset link</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
