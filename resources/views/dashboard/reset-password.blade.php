                        ...
                        <div class="sign-user_card">
                            <div class="sign-in-page-data">
                                <div class="sign-in-from w-100 m-auto">
                                    <h3 class="mb-3 text-center" style="color: #fff">Set Password</h3>
                                    ...
                                    <form id="reset_password_form" action="{{ url('/resetting-password') }}" method="post"
                                        class="mt-4">@csrf
                                        ...
                                        <div class="sign-info" style="text-align: center !important">
                                            <button type="submit" id="reset_password_submit"
                                                class="btn btn-btn btn-primary">Set
                                                Password</button>
                                        </div>
                                    </form>
                                </div>
